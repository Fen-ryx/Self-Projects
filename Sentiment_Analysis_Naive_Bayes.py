...
def test_naive_bayes(test_x, test_y, logprior, loglikelihood, naive_bayes_predict=naive_bayes_predict):
    ...
    error = 1 - sum(np.array(y_hats) == np.array(test_y)) / len(test_y)
...
def get_words_by_threshold(freqs, label, threshold, get_ratio=get_ratio):
    ...
    Output:
        word_list: dictionary containing the word and information on its positive count, negative count, and ratio of 
